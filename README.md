...
基于计算机视觉的跑道边界和中线自动检测系统，支持图像和视频处理，**新增无人机偏离距离计算功能**。
...
- 🚁 **NEW! 偏离计算**：实时计算无人机与跑道中线的偏离距离（像素+米）
...
系统假设输入图像/视频的**中心点为无人机位置**，自动计算无人机与跑道中线的偏离距离。
...
输出文件：`output/result_xxx_offset_log.csv`
...
├── 📄 demo.py                  # 示例脚本
├── 📄 example_offset_analysis.py # 🚁 偏离分析示例
